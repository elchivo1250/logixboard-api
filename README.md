...
## Notes
The more direct mysql access has been updated to use Sequelize, which ended up being much cleaner. Transactions for shipment creation are still outstanding.
